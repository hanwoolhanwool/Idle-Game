...
> **최종 갱신**: 2026-07-22 · **관련 기획서**: [characters-and-companions.md](../../gdd/characters-and-companions.md) §4.3 (스킬 구조) · [content-roadmap.md](../../gdd/content-roadmap.md) §3.5 (스킬 사용 방식)
...
- ~~`CastGate` 기본 인자 불일치~~ **해소(2026-07-22)**: 생성자 기본값을 **제거**해 시전/복귀 상태를 호출부가 반드시 명시하도록 했다(A1안). 잘못된 기본값이 잠복할 경로 자체가 사라졌고, 미사용 `Attack` 상태도 함께 제거되었다([[state-machine]] §11, `docs/reports/cast-gate-default-argument-mismatch.md`).
